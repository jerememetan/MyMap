...
<template>
  <main>
    <div class="w-full pb-8 px-4 sm:px-6 lg:px-0 lg:flex">
      <Timeline
      ...
      <div class="flex-1 space-y-12 md:space-y-16">
        <section
          v-scroll-animate
          class="grid min-h-[70vh] items-center gap-8 rounded-2xl border border-[var(--border)] p-4 sm:p-6 lg:p-0"
        >
          <div class="space-y-4">
            <p
            ...
            <h1
              class="text-xl font-semibold tracking-tight text-[var(--text-h)] sm:text-2xl"
            >
              Cities of Paradox - A deep dive in culture
            </h1>
            <p class="text-[var(--text-h)] text-lg">Hi Prof Jack!</p>
            <p class="text-base leading-relaxed text-[var(--text)]">
        ...
        <div v-scroll-animate><Section01ArrivalDisplacement /></div>
        <div v-scroll-animate><Section02ReligiousAnchors /></div>
        <div v-scroll-animate><Section03ClanHalls /></div>
        <div v-scroll-animate><Section04HakkaEnclaves /></div>
        <div v-scroll-animate><Section05KampongGlam /></div>
        <div v-scroll-animate><Section06LittleIndia /></div>
        <div v-scroll-animate><Section07SriMariamman /></div>
        <div v-scroll-animate><Section08HeritageLanes /></div>
      </div>
    </div>

    <section
      v-scroll-animate
      class="relative overflow-hidden rounded-3xl border border-amber-100/40 bg-linear-to-br from-amber-50/10 via-red-50/5 to-teal-100/10 px-4 py-12 text-center shadow-[0_20px_60px_rgba(0,0,0,0.25)] sm:px-6 md:px-10 md:py-16"
    >
      <div
      ...
      <div class="relative mx-auto max-w-3xl space-y-1">
        ...
        <p class="mx-auto text-[var(--text)] md:text-lg">
        ...
        <p
          class="text-sm uppercase tracking-[0.14em] text-[var(--text)] opacity-80 md:tracking-[0.2em]"
        >
